...
const SignUpHome = () => {
  ...
  return (
    <>
      ...
      <div className="w-[22.75rem] h-[26.5rem] self-center flex flex-col items-center mt-8 ">
        <h1 className="font-cBold text-3xl">Join Twitter today</h1>
        <div className="w-[18.75rem] flex flex-col mt-[2rem] gap-[1.5rem]">
          <SignInButton>
          ...
          <button className="h-[2.4rem] text-white bg-[#000] rounded-full hover:bg-[#272C30]  flex items-center justify-center grow">
            <div>
              <p className="font-cBold">Create demo account</p>
            </div>
          </button>
        </div>
        ...
        <div className="w-[18.75rem] flex flex-col gap-[1.5rem]">
          <button className="h-[2.4rem] text-white bg-[#000] rounded-full hover:bg-[#272C30] flex items-center justify-center grow">
            <div>
        ...
        <div className="ml-4 mt-4 w-[18.75rem] h-[2.4rem]">
          <p className="text-[0.83rem] font-cReg text-gray-900">
            ...
            <span className="text-[#1D9BF0] cursor-pointer hover:underline">Terms of Service</span> and{" "}
            <span className="text-[#1D9BF0] cursor-pointer hover:underline">Privacy Policy</span>, including{" "}
            <span className="text-[#1D9BF0] cursor-pointer hover:underline">Cookie Use.</span>
          </p>
        </div>
        <div className="ml-4 mt-auto w-[18.75rem] h-[2.4rem]">
          <p className="text-[1rem] font-cReg text-slate-600">
            Have an account already?{" "}
            <span className="text-[#1D9BF0] cursor-pointer hover:underline">Log in</span>
          </p>
        </div>
      </div>
    </>
