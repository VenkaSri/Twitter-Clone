...
const UserInfo = () => {
  ...
  return (
    <>
    <div onClick={handleClick} className="flex items-center p-[12px] rounded-full hover:bg-[#e7e7e8] cursor-pointer" id="userInfo">
      ...
      <div className="flex flex-col ml-4 grow-0 leading-[20px]">
        ...
        <span className="text-[#536471] font-cReg text-[15px]">@itzznoone</span>
      </div>
