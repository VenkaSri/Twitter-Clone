  ...
  return (
    <div className="group mr-2 w-20 h-15 clip-tweet-reply-div flex justify-start items-center">
      <svg
        ...
        width="30"
        height="40"
        className="group-hover:bg-[#F8E0EB] fill-[#536471] group-hover:fill-[#F91880] rounded-full w-9 h-9"
      >
        <g>
          <path
            d="M16.697 5.5c-1.222-.06-2.679.51-3.89 2.16l-.805 1.09-.806-1.09C9.984 6.01 8.526 5.44 7.304 
        ...
        2.647-2.91 4.601-3.01 1.651-.09 3.368.56 4.798 2.01 1.429-1.45 3.146-2.1 4.796-2.01 1.954.1 3.714 1.22 4.601 
        3.01.896 1.81.846 4.17-.514 6.67z"
          ></path>
        </g>
      </svg>
      <div>
        <p className="ml-1 text-sm font-cReg group-hover:text-[#F91880] text-[#536471]">
          78
        </p>
      </div>
    </div>
