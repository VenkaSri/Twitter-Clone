        ...
        <div className="overflow-hidden  relative">
          ...
          <div className="h-full w-full absolute top-0 bottom-0 left-0">
            <div
              className={clsx(
                "h-full w-full",
                isFlexCol ? "flex-col-container" : "flex"
              )}
            >
              {children}
            </div>
...
const TLayout = ({ files }) => {
  return (
    <MediaWrapper>
      ...
      <div className="flex-col-container relative basis-0 grow mb-0.5 ">
        <MediaContainer src={files[1]} borderRadius={"rounded-tr-2xl"} />
...
const Single = ({ files }) => {
  return (
    <div className="h-full w-full max-w-full flex-col-container relative mb-0.5 mt-4">
      <div
